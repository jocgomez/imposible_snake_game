...
class UserService extends ChangeNotifier {
  Future<User> getUser() async {
    ...
    if (user != true) {
      return await _initUserScoreInfo(prefs);
    } else {
      return await _getUserScoreInfo(prefs);
    }
  }
  ...
  Future<User> _initUserScoreInfo(SharedPreferences prefs) async {
  ...
  Future<User> _getUserScoreInfo(SharedPreferences prefs) async {
